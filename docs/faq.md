...
Depuis le menu ☰ → « ⚙️ Paramètres » → « 🧭 Revoir la visite guidée ». Elle repart toujours de la première étape. Voir [Guide → Visite guidée](guide.md#visite-guidée-onboarding).
