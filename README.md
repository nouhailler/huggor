...
- Visite guidée en 5 étapes au premier lancement (juste après l'avertissement légal), rejouable à tout moment depuis « ℹ️ À propos » — voir [`src/onboarding.py`](src/onboarding.py)
